...
const getPublishedDateLabel = (paper) => formatDate(paper.published) || 'N/A'
const getDownloadedDateLabel = (paper) => formatDate(paper.downloaded_at) || 'N/A'

const getPaperCategory = (paper) => paper.category || paper.primary_category || 'Uncategorized'
const getNotebookStatus = (paper, queueIds) => {
